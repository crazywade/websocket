...
public class serurity extends WebSecurityConfigurerAdapter {
    ...
    public static void main(String[] args) {
        SpringApplication.run(serurity.class, args);
    }
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication().passwordEncoder(passwordEncoder)
                .withUser("user1").password("$2a$10$7njFQKL2WV862XP6Hlyly.F0lkSHtOOQyQ/rlY7Ok26h.gGZD4IqG").
                roles("USER").and()
                .withUser("user2").password("$2a$10$Q2PwvWNpog5sZX583LuQfet.y1rfPMsqtrb7IjmvRn7Ew/wNUjVwS")
                .roles("ADMIN").and()
                .withUser("user3").password("$2a$10$GskYZT.34BdhmEdOlAS8Re7D73RprpGN0NjaiqS2Ud8XdcBcJck4u")
                .roles("USER");
    }
